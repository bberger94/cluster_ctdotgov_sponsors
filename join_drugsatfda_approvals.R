...
drugsatfda_applications <- read_tsv("data/drugsatfda/Applications.txt",
																		col_types = "cccc") 

# Load Drugs@FDA application submission info
drugsatfda_submissions <- suppressWarnings(read_tsv("data/drugsatfda/Submissions.txt",
																										col_types = "cicicTcc"))
...
# Save data
# ---------- #
write_feather(drug_approval_dates, "drug_approval_dates.feather")
